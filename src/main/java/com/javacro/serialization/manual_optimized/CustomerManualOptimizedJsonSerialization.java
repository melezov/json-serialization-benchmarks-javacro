...
public abstract class CustomerManualOptimizedJsonSerialization {
    ...
    public static Customer deserialize(final Reader reader, final char[] buffer, final int[] tokens, int nextToken, ServiceLocator locator) throws IOException {
    	String _uri = "";
        long _id = 0L;
        String _name = "";
    ...
    public static Customer deserialize(final JsonReader reader, ServiceLocator locator) throws IOException {
    	String _uri = "";
        long _id = 0L;
        String _name = "";
        Profile _profile = new Profile();
